...
})},"{applyPostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.save({autosave:0,isapply:1}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{updatePostButton} click":function(a){b.publishedField().val(g),b.disableLeavePrompt(),a.addClass("is-saving"),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{unpublishPostButton} click":function(){b.publishedFiled().val(i),b.save({autosave:0,isapply:0})},"{deletePostButton} click":function(){b.trash()
