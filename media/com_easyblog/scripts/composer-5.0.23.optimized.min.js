...
var d="green";/error|danger/.test(c.type)&&(d="red"),/success/.test(c.type)&&(d="green"),b.messages().switchClass("style-"+d),b.messages().find("[data-message]").html(c.message)})},"{closeMessage} click":function(){b.manager().removeClass("has-messages")},"{previewPostButton} click":function(){b.publishedField().val(e),b.save({autosave:0,isapply:1}).done(function(a,b,c,d,e){window.open(e)}).always(function(){})},"{savePostButton} click":function(a){b.publishedField().val(e),a.addClass("is-saving"),b.save({autosave:1,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")
})},"{submitPostButton} click":function(){b.disableLeavePrompt(),b.publishedField().val(f),b.save({autosave:0,isapply:0})},"{approvePostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{publishPostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")
})},"{applyPostButton} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.save({autosave:0,isapply:1}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{updatePostButton} click":function(a){b.publishedField().val(g),b.disableLeavePrompt(),a.addClass("is-saving"),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{unpublishPostButton} click":function(){b.publishedField().val(i),b.save({autosave:0,isapply:0})},"{deletePostButton} click":function(){b.trash()
