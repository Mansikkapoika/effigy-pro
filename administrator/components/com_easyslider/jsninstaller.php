...
<script type="text/javascript">
	...
	protected function removeRedundantFiles()
	{
		...
		$folders [JPATH_ROOT . '/plugins/jsneasyslider/'] 		= JPATH_ROOT . '/plugins/jsneasyslider/template';
		...
		foreach ($folders as $key => $folder)
		{
			...
			{
				$fileList   	= JFolder::files($folder, '.', false, false, array('.svn', 'CVS', '.DS_Store', '__MACOSX', 'easyslider.xml', 'mod_easyslider.xml', 'jsneasyslider.xml', 'template.xml'));
