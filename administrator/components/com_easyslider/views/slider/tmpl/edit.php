...
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/backbone-model.js'); ?>"></script>
...
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/backbone-view.js'); ?>"></script>
                ...
                ES_Config: {
                    value: Object.freeze({
                        URL: Object.freeze({
                            ...
                            GET_RATIO_VIDEO: 'index.php?option=com_easyslider&task=slider.getVideoRatio',
