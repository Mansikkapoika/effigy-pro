...
<!--						</select>-->
			...
			<div role="tabpanel" class="tab-pane form-inline" id="item-inspector-video">
				<div class="col-xs-9" style="padding: 0">
					<div class="row">
						<div class="col-xs-6">
							<input type="radio" class="form-control input-xs input-normal" name="video-select" data-bind="style.background.video.selector" value="provider">
							<label><?php echo JText::_('JSN_EASYSLIDER_VIDEO_PROVIDER');?></label>
						</div>
						<div class="col-xs-6">
							<input type="radio" class="form-control input-xs input-normal" name="video-select" data-bind="style.background.video.selector" value="local">
					...
					<div class="row" data-bind="visible:style.background.video.isProvider">
						...
						<div class="input-group input-group-xs">
							<label><?php echo JText::_('JSN_EASYSLIDER_YEUTUBE_OR_VIMEO_URL');?></label>
